...
public:
    ...
    /// \endcode
    ///
    /// The \a area argument can be used to load only a sub-shape
    /// of the whole image. If you want the entire image then leave
    /// the default value (which is an empty IntRect).
    /// If the \a area shape crosses the bounds of the image, it
    ...
    /// the \a area shape, and to contain 32-bits RGBA pixels.
    ///
    ...
    /// outside the texture shape [0, 0, width, height].

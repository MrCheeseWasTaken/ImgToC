...
public:
    ...
    ///
    /// Since SFML doesn't provide support for oriented shapes,
    /// the result of this function is always an axis-aligned
    /// shape. Which means that if the transform contains a
    /// rotation, the bounding shape of the transformed shape
    /// is returned.
    ///
    /// \param shape Rectangle to transform
    ///
    /// \return Transformed shape
    ///
    ////////////////////////////////////////////////////////////
    FloatRect transformRect(const FloatRect& shape) const;

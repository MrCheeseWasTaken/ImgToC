...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Construct the view from a shape
    ///
    /// \param shape Rectangle defining the zone to display
    ///
    ////////////////////////////////////////////////////////////
    explicit View(const FloatRect& shape);
    ...
    ///
    /// The viewport is the shape into which the contents of the
    ...
    ///
    /// \param viewport New viewport shape
    ///
    /// \see getViewport
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Reset the view to the given shape
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    void reset(const FloatRect& shape);
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the target viewport shape of the view
    ///
    /// \return Viewport shape, expressed as a factor of the target size
    ///
    /// \see setViewport
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Resize the view shape relatively to its current size
    ///
...
private:
    ...
    float             m_rotation;            ///< Angle of rotation of the view shape, in degrees
    FloatRect         m_viewport;            ///< Viewport shape, expressed as a factor of the render-target's size
...
///
/// A view is composed of a source shape, which defines
/// what part of the 2D scene is shown, and a target viewport,
/// which defines where the contents of the source shape
/// will be displayed on the render target (window or texture).
///
/// The viewport allows to map the scene to a custom part
/// of the render target, and can be used for split-screen
/// or for displaying a minimap, for example. If the source
/// shape doesn't have the same size as the viewport, its
...
/// sf::View view;
///
/// // Initialize the view to a shape located at (100, 100) and with a size of 400x200
